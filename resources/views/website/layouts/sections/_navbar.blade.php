            ...
            @case('ar')
                ...
                @auth('website')
                    <div class="navbar-donation-request">
                        <a href={{ route('website.donations.create') }} class="main-font btn"><span
                                class="ps-3">{{ __('messages.donation_request') }}</span><img
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link main-font" href={{ route('website.donations.index') }}>{{ __('messages.donations') }}</a>
                        </li>
                        <li class="nav-item">
