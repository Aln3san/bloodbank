        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-5">
                <ul>
                    ...
                    <li class="main-font"><a href="{{ route('website.about') }}">{{ __('messages.about_blood_bank') }}</a></li>
                    <li class="main-font"><a href="{{ route('website.posts.index') }}">{{ __('messages.articles') }}</a>
                    </li>
                    <li class="main-font"><a
                            href="{{ route('website.donations.index') }}">{{ __('messages.donation_requests') }}</a>
                    </li>
                    <li class="main-font"><a href="{{ route('website.about') }}">{{ __('messages.about_us') }}</a></li>
                </ul>
            </div>
