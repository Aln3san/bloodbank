...
@section('content')
    ...
    <section class="header-page container border my-5 p-3">
        ...
        <span>/</span>
        <span class="main-font">{{ __('messages.articles') }}</span>
        <span>/</span>
        <span class="main-font">{{ $post->title }}</span>
    </section>
    ...
    <section class="one-post">
        <div class="container">
            <div class="post-img mb-3">
                <img src="{{ $post->photo_url }}" class="d-block mx-auto" />
            </div>
            <div class="post-details">
                <div class="post-title d-flex justify-content-between align-items-center mb-4">
                    <p class="main-font">{{ $post->title }}</p>
                    <a href="#" class="articles-love border"><i class="fa-regular fa-heart"></i></a>
                </div>
                <div class="post-description border p-3 mb-4">
                    <p class="main-font">
                        {{ $post->content }}
                    </p>
                </div>
