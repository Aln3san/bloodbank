...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute أحرفًا أبجدية رقمية ورموزًا ببايت واحد فقط.',
    ...
    'password' => [
        ...
        'uncompromised' => 'قيمة :attribute المعطاة ظهرت في تسريب بيانات. الرجاء اختيار :attribute أخرى.',
    ],
    'present' => 'يجب أن يكون حقل :attribute حاضرًا.',
    'present_if' => 'يجب أن يكون حقل :attribute حاضرًا عندما يكون :other هو :value.',
    'present_unless' => 'يجب أن يكون حقل :attribute حاضرًا ما لم يكن :other هو :value.',
    ...
    'required_without_all' => 'حقل :attribute مطلوب عندما لا تكون أيٌّ من :values موجودة.',
